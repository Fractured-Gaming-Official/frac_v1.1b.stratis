...
if (((getPlayerUID _player) in call gearLevel2)) then {
...
_player addMagazines ["6Rnd_45ACP_Cylinder", 6]; //Add handgun magazines first so one gets loaded
_player addWeapon "hgun_Pistol_heavy_02_F"; //Handgun
...
_player selectWeapon "hgun_Pistol_heavy_02_F"; //Select Active Weapon
