...
_player addMagazines ["16Rnd_9x21_Mag", 4]; //Add handgun magazines first so one gets loaded
_player addWeapon "hgun_Rook40_F"; //Handgun
...
_player selectWeapon "hgun_Rook40_F"; //Select Active Weapon
