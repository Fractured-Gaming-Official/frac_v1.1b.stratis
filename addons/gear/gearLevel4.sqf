...
if (((getPlayerUID _player) in call gearLevel4)) then {
...
_player addHeadgear "H_Cap_blk_Raven"; //Hat or helmet. Overwrites, add as item if you want it a an extra item
